...
for insize in ${nsize_in}; do
   ...
   if test $res = 0; then
      petsc_testrun "${diff_exe} /cygdrive/c/checkouts/modflow/petsc-3.14.6/src/sys/tests/output/ex54_1_options_file-ex54options_1h.out ex54_1_options_file-ex54options_1h.tmp" diff-${testname}.out diff-${testname}.out diff-${label} ""
   else
